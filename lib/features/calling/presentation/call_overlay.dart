...
/// Shows the call overlay on top of the current screen
Future<void> showCallOverlay(BuildContext context) {
  return Navigator.of(context, rootNavigator: true).push(
    PageRouteBuilder(
      opaque: false,
      barrierColor: Colors.black87,
      pageBuilder: (context, animation, secondaryAnimation) {
        return const CallOverlay();
      },
...
class _CallOverlayState extends ConsumerState<CallOverlay>
  ...
  Widget build(BuildContext context) {
    ...
    // Listen for call end and close overlay
    ref.listen<CallState>(callProvider, (previous, next) {
      if (next.activeCall == null && previous?.activeCall != null) {
